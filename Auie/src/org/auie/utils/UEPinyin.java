...
public class UEPinyin {
	
    private static final String TAG = "UE-PINYIN";
    private static final boolean DEBUG = true;

    public static String transformPinYin(String input) {
    ...
    private static UEPinyin sInstance;
    ...
    protected UEPinyin(boolean hasChinaCollator) {
