...
public final class UEAnimatorProxy extends Animation {
	
	public static final boolean NEEDS_PROXY = Integer.valueOf(Build.VERSION.SDK).intValue() < Build.VERSION_CODES.HONEYCOMB;

    private static final WeakHashMap<View, UEAnimatorProxy> PROXIES = new WeakHashMap<View, UEAnimatorProxy>();

    public static UEAnimatorProxy wrap(View view) {
        UEAnimatorProxy proxy = PROXIES.get(view);
        if (proxy == null || proxy != view.getAnimation()) {
            proxy = new UEAnimatorProxy(view);
    ...
    private UEAnimatorProxy(View view) {
