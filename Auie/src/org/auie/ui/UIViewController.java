...
public class UIViewController extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF45C01A;
	...
	public UIViewController(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public UIViewController(Context context, AttributeSet attrs, int defStyle) {
